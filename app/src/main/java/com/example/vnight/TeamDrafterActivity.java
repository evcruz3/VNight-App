...
public class TeamDrafterActivity extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    RecyclerView reservedPlayersView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reservedPlayersView = findViewById(R.id.layout3);
        reservedPlayersView.setAdapter(reservedPlayersAdapter);
        reservedPlayersView.setLayoutManager(new LinearLayoutManager(this));
